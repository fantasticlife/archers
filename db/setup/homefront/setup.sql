...
insert into storylines (title, position) values( 'Ralph, Isabel and Dorothea', 1);
insert into storylines (title, position) values( 'Lost Boys', 2);
insert into storylines (title, position) values( E'Kitty\'s baby', 3);
insert into storylines (title, position) values( 'Refugees', 4);
